...
public struct ERTFontUtils: Sendable {
  public static let `default` = ERTFontUtils()

  #if canImport(AppKit)
    public func font(_ font: NSFont, with descriptor: NSFontDescriptor)
      -> NSFont
    {
    ...
    public func font(
      _ font: NSFont,
      modifyingDescriptor: (NSFontDescriptor) -> NSFontDescriptor
    ) -> NSFont {
    ...
    public func font(
      _ font: NSFont,
      with symbolicTraits: NSFontDescriptor.SymbolicTraits
    ) -> NSFont {
      return self.font(
        font,
        with: font.fontDescriptor.withSymbolicTraits(symbolicTraits)
      )
    }

    public func font(
      _ font: NSFont,
      modifySymbolicTraits: (inout NSFontDescriptor.SymbolicTraits) -> Void
    ) -> NSFont {
  ...
  #elseif canImport(UIKit)
    public func font(_ font: UIFont, with descriptor: UIFontDescriptor)
      -> UIFont
    {
    ...
    public func font(
      _ font: UIFont,
      modifyingDescriptor: (UIFontDescriptor) -> UIFontDescriptor
    ) -> UIFont {
      return self.font(font, with: modifyingDescriptor(font.fontDescriptor))
    }
    ...
    public func font(
      _ font: UIFont,
      modifySymbolicTraits: (inout UIFontDescriptor.SymbolicTraits) -> Void
    ) -> UIFont {
      var traits = font.fontDescriptor.symbolicTraits
      modifySymbolicTraits(&traits)
      return self.font(font, with: traits)
      ...
      public func uiFont(from font: Font) -> UIFont? {
        ...
        let font =
          nsAttributedString.attribute(.font, at: 0, effectiveRange: nil)
          as? UIFont
        return font
      }
